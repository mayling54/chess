...
public class Piece {
	...
	public ArrayList<Square> getLegalMoves(Board b, Square currentSquare) {
		ArrayList<Square> ret = getDiagonalOccupations(b.getSquareArray(), currentSquare.getXNum(), currentSquare.getYNum());
	...
	public Square[] getControlledSquares(Square[][] board, Square currentSquare) {
		return null;
	}
}